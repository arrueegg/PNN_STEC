#!/bin/bash
#SBATCH --job-name=sweep_factorized
#SBATCH --output=hp_search/logs/sweep_factorized_%j.out
#SBATCH --error=hp_search/logs/sweep_factorized_%j.err
...
# Hyperparameter sweep for FactorizedSTEC model only
# Usage: sbatch hp_search/sweep_factorized_cluster.sh [num_agents]
...
echo "=========================================="
echo "FactorizedSTEC Hyperparameter Sweep"
echo "=========================================="
