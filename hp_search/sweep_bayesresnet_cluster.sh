#!/bin/bash
#SBATCH --job-name=sweep_bayesresnet
#SBATCH --output=hp_search/logs/sweep_bayesresnet_%j.out
#SBATCH --error=hp_search/logs/sweep_bayesresnet_%j.err
...
# Hyperparameter sweep for BayesianResNetSTEC model only
# Usage: sbatch hp_search/sweep_bayesresnet_cluster.sh [num_agents]
...
NUM_AGENTS=${1:-5}  # Default to 5 agents if not specified

echo "=========================================="
echo "BayesianResNetSTEC Hyperparameter Sweep"
echo "=========================================="
