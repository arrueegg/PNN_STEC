#!/bin/bash
#SBATCH --job-name=test_resnet_nll
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
#SBATCH --output=hp_search/logs/test_resnet_nll_%j.log
#SBATCH --error=hp_search/logs/test_resnet_nll_%j.err

# Test: ResNet_NLL on Euler Cluster
