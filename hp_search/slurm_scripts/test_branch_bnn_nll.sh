#!/bin/bash
#SBATCH --job-name=test_branch_bnn
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
#SBATCH --output=hp_search/logs/test_branch_bnn_%j.log
#SBATCH --error=hp_search/logs/test_branch_bnn_%j.err

# Test: Branch_BNN_NLL (Existing baseline) on Euler Cluster
...
python src/main.py \
  ...
  --override "model.model_type=Branch_BNN_NLL" \
