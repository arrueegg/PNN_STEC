...
#SBATCH --output=hp_search/logs/test_mlp_nll_%j.log
#SBATCH --error=hp_search/logs/test_mlp_nll_%j.err

# Test: MLP_NLL (Basic baseline) on Euler Cluster
...
python src/main.py \
  ...
  --override "model.model_type=MLP_NLL" \
