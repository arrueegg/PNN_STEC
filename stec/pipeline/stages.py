...
STAGES: list[Stage] = [
    ...
    Stage(
        ...
        caveats=[
            ...
            "(coverage_common_station_days, N=10,673 - see that stage's caveats for "
            ...
            "per-station follow-up landed, and N=10,673 since the 2026-09-18 solver-failure "
            "exclusion of URUM, DOY 365) instead "
    ...
    Stage(
        ...
        caveats=[
            ...
            "x 2-weighting common set the positioning tables use (N=10,673 - see "
            "positioning_coverage's caveats for the full 10,387 -> 10,674 -> briefly "
            "9,606 -> 10,674 -> 10,673 (solver-failure exclusion) history; owner decision "
    ...
    Stage(
        ...
        caveats=[
            ...
            "(N=10,673 - see positioning_coverage's caveats for the full "
            "10,387 -> 10,674 -> briefly 9,606 -> 10,674 -> 10,673 (solver-failure "
            "exclusion) history) and the 10 m "
    ...
    Stage(
        ...
        caveats=[
            ...
            "(coverage_common_station_days, N=10,673 - moved 10,387 -> 10,674 (GIM-arm "
            ...
            "follow-up) -> 10,673 (2026-09-18 solver-failure exclusion, URUM DOY 365) - "
            "a coverage-only "
