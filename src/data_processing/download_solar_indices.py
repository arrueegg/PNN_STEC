...
class OmniDownloader:
    def __init__(self, base_folder, start_date, end_date):
        ...
        self.txt_file = os.path.join(base_folder, f"omni_hourly_{start_date[:4]}-{end_date[:4]}.txt")
        self.h5_file = os.path.join(base_folder, f"omni_hourly_{start_date[:4]}-{end_date[:4]}.h5")
    ...
    def download_txt(self):
        ...
        if not os.path.exists(self.txt_file):
            ...
            cmd = ["wget", "--post-data", self.post_data, self.base_url, "-O", self.txt_file]
