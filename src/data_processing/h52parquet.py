...
def main():
    parser = argparse.ArgumentParser(description="Convert nested HDF5 GNSS STEC files to station-split Parquet.")
    ...
    parser.add_argument("--parquet_path", default="/scratch2/arrueegg/WP4/PNN_STEC/parquet_data", type=str,
