...
`multiday_results/analyses/positioning_coverage/rebuilt/multiday_summary.csv` (43,215 rows,
all four methods, 2026-09-14), read via the declared `positioning_distributions` pipeline
stage's `overall_percentile_summary.csv` + `overall_exceedance.csv`, reproduced exactly in
`multiday_results/analyses/positioning_distributions/rebuilt/TABLE5_NUMBERS.md` (regenerated by
that stage, not hand-edited):
