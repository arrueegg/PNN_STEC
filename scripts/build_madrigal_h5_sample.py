...
def main():
    ...
    p.add_argument('--n_workers', type=int, default=None, help='Number of parallel workers (default: use all CPUs)')
    ...
    out = build_sample(args.madrigal_path, args.out_h5, split=args.split, n_files=args.n_files, n_workers=args.n_workers)
    if out is None:
